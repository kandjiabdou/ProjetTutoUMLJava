...
public class Client extends JFrame implements Runnable{
   ...
   private String[] itemSacString= new String[15];
  // private ArrayList<String> itemSacList;
   ...
   // Vue carte en format txt
	...
	static final int BOUTON_CONNECTER = 15;
	static final int BOUTON_INSCRIRE = 17;
	...
	private static final String MESSAGE_CONNECTION = "connection";
	private static final String MESSAGE_INSCRIPTION = "inscription";
	...
	public void run(){
//		Thread Lecteur = new Thread(new LecteurConnection());
//		Lecteur.start();
//		System.out.println("Lecteur créé .......................");
		Thread LecteurC = new Thread(new Lecteur());
		LecteurC.start();
		System.out.println("Lecteur créé .......................");
	}
	...
	private void fenetreJeu() {
		...
		tabOnglet.addTab("DISCUSSIONS", initJeu()); //tabOnglet.addTab("JEU", initJeu());
		tabOnglet.addTab("Parametres", panSavegarder()); //tabOnglet.addTab("SAUVEGARDER/ QUITTER", panSavegarder());
		panPrincipal.add(tabOnglet, BorderLayout.CENTER);
		this.add(panPrincipal);
	}
	private JPanel panSavegarder() {
		JPanel p=new JPanel();
		p.setBorder(BorderFactory.createEtchedBorder());
		p.add(new JLabel("Savegarder et quitter la partie"));
		p.add(new JButton("Sauvegarder"));
		return p;
	}
...
//		panArmure.add(desequiperChaussure);
	...
	public JPanel panAction() {
		...
		// Ce signe appratient à Abdou Kandji 
		// Etudiant en 1ere année de DUT informatique 
		// à l'Université Sorbonne Paris Nord
		// IUT de Villetaneuse !!!!!!!!!!!!!!!!
		// Fait le 02/06/2020 à 20h:50min à Palaiseau France
