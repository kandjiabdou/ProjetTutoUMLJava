...
public class Epee extends Arme {
	...
	public static String[] TO_STRING={"e","e","e"};
	public static int[] DEAGAT={2,4,5};
	public static int[] MANIABILITE={3,3,2};
	public static int[] PORTEE={1,3,4};
	
    public Epee(Carte carte,String nom) {
        super(carte,nom);
    }
    public Epee(Carte carte, int niveau) {
    ...
    public static Epee creerEpee(Carte c) {
